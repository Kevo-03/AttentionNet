...
IDX_DIR = os.path.join(PROJECT_ROOT, "processed_data/memory_safe_bidirectional_l7")
MAX_LEN = 784  # 28x28
ROWS, COLS = 28, 28

DATA_FILENAME = "data_bidirectional_l7.npy"
LABELS_FILENAME = "labels_bidirectional_l7.npy"
